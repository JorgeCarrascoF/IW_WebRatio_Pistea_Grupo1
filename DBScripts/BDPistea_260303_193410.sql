...
-- se refiere a [rel10]
alter table "public"."pista"  add column  "reserva_oid"  int4;
alter table "public"."pista"   add constraint fk_pista_reserva foreign key ("reserva_oid") references "public"."reserva" ("oid");
...
alter table "public"."pista"  add column  "valoracion_oid"  int4;
alter table "public"."pista"   add constraint fk_pista_valoracion foreign key ("valoracion_oid") references "public"."valoracion" ("oid");


-- organiza [rel13]
alter table "public"."user"  add column  "torneo_oid"  int4;
alter table "public"."user"   add constraint fk_user_torneo foreign key ("torneo_oid") references "public"."torneo" ("oid");


-- gestiona [rel14]
alter table "public"."user"  add column  "pista_oid"  int4;
alter table "public"."user"   add constraint fk_user_pista foreign key ("pista_oid") references "public"."pista" ("oid");


-- User_Valoracion [rel16]
alter table "public"."user"  add column  "valoracion_oid"  int4;
alter table "public"."user"   add constraint fk_user_valoracion foreign key ("valoracion_oid") references "public"."valoracion" ("oid");


-- User_Incidencia [rel17]
alter table "public"."user"  add column  "incidencia_oid"  int4;
alter table "public"."user"   add constraint fk_user_incidencia_2 foreign key ("incidencia_oid") references "public"."incidencia" ("oid");
...
-- reporta [rel3]
alter table "public"."user"  add column  "incidencia_oid_2"  int4;
alter table "public"."user"   add constraint fk_user_incidencia foreign key ("incidencia_oid_2") references "public"."incidencia" ("oid");
...
-- realiza [rel7]
alter table "public"."user"  add column  "reserva_oid"  int4;
alter table "public"."user"   add constraint fk_user_reserva foreign key ("reserva_oid") references "public"."reserva" ("oid");


-- escribe [rel8]
alter table "public"."user"  add column  "valoracion_oid_2"  int4;
alter table "public"."user"   add constraint fk_user_valoracion_2 foreign key ("valoracion_oid_2") references "public"."valoracion" ("oid");


-- se juega en [rel9]
alter table "public"."pista"  add column  "torneo_oid"  int4;
alter table "public"."pista"   add constraint fk_pista_torneo foreign key ("torneo_oid") references "public"."torneo" ("oid");
