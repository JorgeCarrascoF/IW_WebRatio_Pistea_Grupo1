...
alter table "public"."incidencia"   add constraint fk_incidencia_user_2 foreign key ("user_oid") references "public"."user" ("oid");
...
alter table "public"."incidencia"   add constraint fk_incidencia_user foreign key ("user_oid_2") references "public"."user" ("oid");
...
alter table "public"."valoracion"   add constraint fk_valoracion_user_2 foreign key ("user_oid_2") references "public"."user" ("oid");
